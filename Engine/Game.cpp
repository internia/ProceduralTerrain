...
void Game::CreateDeviceDependentResources()
{
	...
	//load Textures
	CreateDDSTextureFromFile(device, L"grass.dds",		nullptr,	m_texture1.ReleaseAndGetAddressOf());
	CreateDDSTextureFromFile(device, L"snow.dds", nullptr,	m_texture2.ReleaseAndGetAddressOf());
